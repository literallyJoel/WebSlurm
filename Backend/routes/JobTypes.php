...
class JobTypes
{
    ...
    public function create(ServerRequestInterface $request, ResponseInterface $response): ResponseInterface
    {
        ...
        try {
            ...
            $stmt = $pdo->prepare("INSERT INTO jobTypes (jobName, jobDescription, script, userID, fileUploadCount, hasOutputFile, outputCount) VALUES (:jobName, :jobDescription, :script, :userID, :fileUploadCount, :hasOutputFile, :outputCount)");
    ...
    public function updateById(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        try {
            ...
            // Update the job type
            $updateJobTypeStmt = $pdo->prepare("UPDATE jobTypes SET jobName = :jobName, script = :script, jobDescription = :JobDescription, fileUploadCount = :fileUploadCount, hasOutputFile = :hasOutputFile, outputCount = :outputCount WHERE jobTypeID = :jobTypeID");
